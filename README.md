...
#### Short Syntax
You can use [short names](http://framework.zend.com/manual/current/en/modules/zend.form.advanced-use-of-forms.html#short-names) offered by ZF2 for type, for example, instead of writing `Zend\Form\Element\Text` for defining form elements you can just type `text` and it will work.
```php
